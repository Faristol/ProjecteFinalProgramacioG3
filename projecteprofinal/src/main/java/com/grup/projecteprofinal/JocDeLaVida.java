	...
	public void iniciarInfoStart() {
		condicionsInicials.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//quan es polse en start es desabilitar� el bot� Dibuixa
				crearListenerStart();
			}
		});
		info.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String informacio = "\n"
						+ "El Joc de la Vida, creat per John Conway el 1970, �s un joc de simulaci� de c�l�lules en un tauler bidimensional.\nAquest joc �s conegut com a \"aut�mat cel�lular\" i ha captivat l'inter�s de matem�tics i entusiastes durant d�cades.\nLes regles son les seg�ents:"
						+ "\n\nTota c�l�lula viva amb menys de dos ve�nes vives mor (de solitud).\n"

						+ "Tota c�l�lula viva amb m�s de tres ve�nes vives mor (d'exc�s de concentraci�).\n"
						+ "Tota c�l�lula viva amb dos o tres ve�nes vives segueix viva per a la seg�ent generaci�.\n"
						+ "Tota c�l�lula morta amb exactament tres ve�nes vives torna a la vida.\n"
						+ "El joc acaba quan totes les c�l�lules han mort.\n" + "\n"
						+ "Per a comen�ar polsa en Dibuixa, elegeix entre establir les condicions inicials t� mateixa o aleatoriament i polsa en Start.\n"
						+ "Podr�s pausar, reprendre, aturar, accelerar o alentir les generacions en qualsevol moment.\n"
						+ "En acabar es mostrar� un panell amb estad�stiques, aix� mateix per a generar altres condicions inicials, haur�s\n"
						+ "d'apretar novament en dibuixa.";
				JOptionPane.showMessageDialog(null, informacio, "Informaci�", JOptionPane.INFORMATION_MESSAGE);
