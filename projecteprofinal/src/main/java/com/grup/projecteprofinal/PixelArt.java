...
public class PixelArt extends JFrame {
	...
	public void creacioPanell() {
	    ...
	    JButton btnDescription = new JButton("Descripci√≥n");
	    ...
	    btnDescription.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
	            JOptionPane.showMessageDialog(null, "Bienvenido a Pixel Art. AquÌ puedes crear tu propio arte pixel por pixel.\n"
	                    + "1. Elije un tamaÒo de cuadrÌcula para comenzar.\n"
	                    + "2. Selecciona un color usando el botÛn 'Selecciona Color'.\n"
