...
public class ProcessamentRegistre {
	...
	public static void procesamentCampsRegistre(String nom, String cognoms, String poblacio, String correu,
		...
		//també que les contrassenyes tinguen com a mínim 8 caràcters.
		 ...
		 if (!correuCorrecte) {
		        JOptionPane.showMessageDialog(null, "El format de correu introduït no és vàlid", "Error", JOptionPane.ERROR_MESSAGE);
		        return;
		    }

		    if (!longitudCorrecta) {
		        JOptionPane.showMessageDialog(null, "Les contrassenyes deuen tindre almenys 8 caràcters", "Error", JOptionPane.ERROR_MESSAGE);
		        return;
		    }

		    if (!sonIguals) {
		        JOptionPane.showMessageDialog(null, "Les contrassenyes no coincideixen", "Error", JOptionPane.ERROR_MESSAGE);
		        return;
		    }
